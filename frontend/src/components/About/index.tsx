...
const About = ({title, text} : IAbout) => {
  ...
  return (
    <div className='About'>
        ...
        <p style={{color:"#DC143C"}}><strong>ATENÇÃO: TODA E QUALQUER REFERÊNCIA À  TROCA DE CURRÍCULO DA ECP NESSE SITE NÃO PASSA DE ESPECULAÇÃO UTILIZADA PARA FINS DE DESENVOLVIMENTO. AS INFORMAÇÕES SOBRE A ALTERAÇÃO CURRICULAR DA ECP AINDA ESTÃO EM PROCESSO DE CONSOLIDAÇÃO</strong></p> 
   </div>
  )
}
